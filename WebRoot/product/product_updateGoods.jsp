...
<body>
	<div class="page-container">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<input type="text" class="input-text" placeholder="请输入商品名称"
					value="${goods.goodsname }" id="goodsname">
			</div>
		</div>
		<br>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				</select> <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;可修改为：</label> <select
					id="select_goodsclassifyid">
					<c:forEach items="${goodsclassifyList}" var="gl">
						<option value="${gl.goodsclassifyid }">${gl.goodsclassifyname }</option>
					</c:forEach>
				</select>
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" id="goodsstock" value="${goods.goodsstock }"
					class="input-text" style="width:90%"> 件
			</div>
		</div>
		...
		<button class="btn btn-primary radius" onclick="updateGoodsApply()"
			style="margin-left: 30%;width: 30%">确认修改商品，提交审核</button>
	...
	<script type="text/javascript">
		function updateGoodsApply() {
			...
			var ishot = document.getElementById("ishot").value;
			 ...
			 alert(goodsid + "======" + goodsname + "======"+goodsdesc + "======"+ select_goodsclassifyid + "======" + marketprice + "======" + shopprice
			...
			var goods = {
	         ...
	         alert(goods);
			if (goodsid != "" && goodsname != "" && goodsdesc != ""
				&& select_goodsclassifyid != "" && marketprice != "" && shopprice != ""
				&& issale != "" && isbest != "" && isrecom != ""
				&& isnew != "" && ishot != "") {
				$.ajax({
					type : "POST",
					url : '${pageContext.request.contextPath }/product/product_updateGoods.action',
