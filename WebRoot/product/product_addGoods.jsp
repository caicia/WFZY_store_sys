...
<body>
	<div class="page-container">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select id="select_goodsclassifyid">
					<c:forEach items="${goodsclassifyList }" var="g">
						<option value="${g.goodsclassifyid }">${g.goodsclassifyname }</option>
					</c:forEach>
				</select>
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea id="goodsdesc" cols="" rows="" class="textarea"
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" id="marketprice" class="input-text"
					style="width:90%"> 元
			</div>
		</div>
		<br>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" id="shopprice" class="input-text"
					style="width:90%"> 元
			</div>
		</div>
		<br>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" id="salenum" class="input-text" style="width:90%">
				件
			</div>
		</div>
		<br>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select id="issale">
					<option value="0" selected="selected">请选择是否上架</option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select id="isbest">
					<option value="0" selected="selected">请选择是否为精品</option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select id="isrecom">
					<option value="0" selected="selected">请选择是否为推荐</option>
					<option value="1">是</option>
					<option value="0">否</option>
				</select>
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select id="isnew">
					<option value="0" selected="selected">请选择是否为新品</option>
					<option value="1">是</option>
					<option value="0">否</option>
				</select>
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select id="ishot">
					<option value="0" selected="selected">请选择是否为热销产品</option>
					<option value="1">是</option>
					<option value="0">否</option>
				</select>
			</div>
		...
		<button class="btn btn-primary radius" onclick="addGoodsApply()"
			style="margin-left: 30%;width: 30%">确认添加商品，提交审核</button>
	...
	<script type="text/javascript">
		function addGoodsApply() {
		    alert("1111");
			var goodsname = document.getElementById("goodsname").value;
			var select_goodsclassifyid = document.getElementById("select_goodsclassifyid").value;
			...
			var isbest = document.getElementById("isbest").value;
			var isrecom = document.getElementById("isrecom").value;
			var isnew = document.getElementById("isnew").value;
			var ishot = document.getElementById("ishot").value;
			
			alert(goodsname + "======" + select_goodsclassifyid + "======" + marketprice + "======" + shopprice+"======" + salenum
				+ "======" + issale + "======" + isbest + "======" + isrecom + "======" + isnew + "======" + ishot) 
			
			 var goods={
			            goodsname : goodsname,
						goodsclassifyid : select_goodsclassifyid,
						goodsdesc : goodsdesc,
			...
			if( goodsname != "" && goodsdesc != ""
				&& select_goodsclassifyid != "" && marketprice != "" && shopprice != ""
				&& issale != "" && isbest != "" && isrecom != ""
				&& isnew != "" && ishot != "" ){
			   $.ajax({
			      type : "POST",
				  url : '${pageContext.request.contextPath }/product/addGoodsApply.action',
				...
				success : function(data) {
					if(data.message == 1)
					{
						...
						window.location = "${pageContext.request.contextPath }/shop/product/product_list.action"
					}
					else
					{
						alert("提交失败，请验证后继续提交");
				...
				error : function(data) {alert("提交失败，请验证后继续提交")},
	...
	<script type="text/javascript">
		$(function() {
			...
			var uploader = WebUploader.create({
				...
				// 文件接收服务端。
				server : '${pageContext.request.contextPath }/uploadImg.action',
					...
					if (file.getStatus() === 'invalid') {
						...
						uploader.makeThumb(file, function(error, src) {
							...
							if (isSupportBase64) {
								...
								$.ajax('${pageContext.request.contextPath }/lib/webuploader/0.1.5/server/preview.php', {
									method : 'POST',
									data : src,
									dataType : 'json'
