...
<body>
	...
	<c:forEach items="${shopList}" var="i">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>店铺名称：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" placeholder=""
						placeholder="店铺名称" id="shopName" name="shopName"   value="${i.shopname }">
				</div>
			</div>
			<br>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>店铺类型：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<select name="shopType" id="shopType">
						<c:forEach items="${Shopclassify}" var="t">
							<option value="${i.shopclassifyid }">${t.shopclassifyname }</option>
						</c:forEach>
					</select>
				</div>
			</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="telNumber" id="telNumber" placeholder="" value="${i.shoptelephone} "
						class="input-text" >
				</div>
			</div>
			<br>
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>门店地址：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="shopAddress" id="shopAddress" placeholder="" value="${i.shopaddress} "
						class="input-text" >
				</div>
			</div>
			<br>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>是否能够开发票：</label>
				<div class="formControls col-xs-8 col-sm-9">
				
					<select name="shopShowPaper" id="shopShowPaper">
						<c:if test="${i.isinvoice eq '1'}"><option value="1">能</option></c:if>
					    <c:if test="${i.isinvoice eq '0'}"><option value="0">不能</option></c:if>
					</select>
				</div>
			</div>
			<br>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">发票说明：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="paperShow" id="paperShow" placeholder="" value="${i.invoiceremarks }"
						class="input-text" >
				</div>
			</div>
			<br>
	...
	<script type="text/javascript">
	   function shopApplyAuccess(shopid)
	   {
			...
			var shopShowPaper = document.getElementById("shopShowPaper").value;
...
<script type="text/javascript">
		$(function() {
			...
			var uploader = WebUploader.create({
				...
				// 文件接收服务端。
				server : '${pageContext.request.contextPath }/shop/uploadShopUpdate.action',
